...
async function process() {
  ...
  const total = askUbuntuResult.total + chatbotResult.total + webApplicationResult.total;
  const correct = askUbuntuResult.correct + chatbotResult.correct + webApplicationResult.correct;
