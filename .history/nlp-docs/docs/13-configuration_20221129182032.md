...
| scripts | Path to the script/s to load by the bot. Can be a single path or an array of paths |

TODO: check default validators loaded (see registerDefault method)

## DialogManager

packages/bot/src/dialog-manager.js
...
packages/builtin-compromise/src/builtin-compromise.js
...
packages/builtin-default/src/builtin-default.js
...
packages/builtin-duckling/src/builtin-duckling.js
...
packages/builtin-microsoft/src/builtin-microsoft.js
...
packages/connector/src/connector.js
36,24: this.applySettings(this.settings, settings);
...
packages/database/src/database.js
