...
If your connector is REST-based, an easy point to start is by extending the

<GithubLink to="https://github.com/axa-group/nlp.js/blob/master/packages/rest-connector/src/rest-connector.js">
  RestConnector
</GithubLink>
