...
case you might be interested in implementing your own [connector](/technical-reference/key_concepts#connector).

## #Implementing your custom connector

If your connector is REST-based, an easy point to start is by extending the [_RestConnector
from @nlpjs/rest-connector_](https://github.com/axa-group/nlp.js/blob/master/packages/rest-connector/src/rest-connector.js).
