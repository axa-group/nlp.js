...
For integration with duckling please visit [Builtin Duckling](./builtin-duckling). Duckling support more languages, but you will need to have an instance of duckling up and running.
