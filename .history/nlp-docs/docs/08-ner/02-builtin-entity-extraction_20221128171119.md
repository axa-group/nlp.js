...
For integration with duckling please visit [Builtin Duckling](./03-builtin-duckling.md). Duckling support more languages, but you will need to have an instance of duckling up and running.
