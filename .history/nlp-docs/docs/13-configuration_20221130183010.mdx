...
| Setting    |  Type  | Default value                                                                     | Description                                            |
| :--------- | :----: | :-------------------------------------------------------------------------------- | ------------------------------------------------------ |
| serviceUrl | string | env.DIRECTLINE_SERVICE_URL or 'http://localhost:3000' if environment var is empty | Service URL where the connector should send activities |
