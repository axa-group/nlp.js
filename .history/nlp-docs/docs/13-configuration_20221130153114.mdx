...
as memory-adapter has used the tag _memory_adapter_ , when it is loaded by the _database_component, you can provide the configuration in two ways. One is by using the \_database_ configuration:
