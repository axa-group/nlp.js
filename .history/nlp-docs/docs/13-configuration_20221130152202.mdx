...
| autosaveInterval | integer |       0       | In case _autosave_ is true, the periodicity, in milliseconds, to save the contents. Set to 0 to automatically store any change to the filesystem. |
