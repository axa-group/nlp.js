...
| Setting |  Type  | Description                                                                                                                                                 |
| :------ | :----: | :---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| url     | string | The connection string URI tu use to connect to the database.<br/>If not specified,the value of the **MONGO_URL environment variable** will be used instead. |
