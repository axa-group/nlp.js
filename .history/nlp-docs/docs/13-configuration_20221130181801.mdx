...
| :-------------- | :-----: | :----------------------------------------------------------------------------------------------------------------------------- |
| autoRemoveFiles |         |                                                                                                                                |
| uploadDir       | string  | Path to the directory where uploaded files shall be stored.<br/>Defaults to './uploads/'                                       |
| maxFileSize     | integer | Maximum allowed size, in bytes, of uploaded files.<br/>Defaults to 8000000                                                     |
