...
To help on this, nlp.js offers the possibility to define a conversation flow as a group of dialogs connected among them. These dialogs can contain sentences and questions to the user, and actions to execute. All the information gathered can be stored in the context of the conversation to be used in the next dialog or later.
...
You will find more information in the next sections but take a look to the example.

## Example

In order to understand how everything is connected, take a look to [this example](https://github.com/axa-group/nlp.js/blob/master/examples/20-bot-simple-flow), specially to `greetings.hello` intent defined in corpus.dlg to see how calls `hellodialog` defined in script.dlg file.

![](../../../screenshots/bot-example-vid.gif)
