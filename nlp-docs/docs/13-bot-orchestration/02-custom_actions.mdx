...
Now that we have our custom action defined and registered, we can make us of it:
...
Custom actions can receive a JSON object as a parameter from the conversation flow.
